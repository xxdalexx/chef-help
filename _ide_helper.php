...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Database\Eloquent\Factories\Factory::fakePrice();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function fakeUnit()
        {
                        return \Illuminate\Database\Eloquent\Factories\Factory::fakeUnit();
        }
